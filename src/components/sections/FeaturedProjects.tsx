                ...
                <div className="flex flex-wrap items-center gap-4 pt-4 border-t border-white/[0.06]">
                  ...
                  {project.githubUrl && (
                    <a
                      ...
                      className="font-mono text-xs text-[#A1A1AA] hover:text-white flex items-center gap-1.5 transition-colors group"
                    >
                  ...
                  {/* Live Demo (if available in data) */}
                  {project.liveDemoUrl && (
                    <a
                      ...
                      className="font-mono text-xs text-[#EDEDED] hover:text-white flex items-center gap-1.5 transition-colors group"
                    >
                  ...
                  <a
                    ...
                    className="font-mono text-xs text-[#A1A1AA] hover:text-[#EDEDED] flex items-center gap-1.5 px-3 py-1 rounded-full border border-white/[0.08] hover:border-white/[0.2] bg-white/[0.02] transition-all ml-auto"
                  >
